...
const renderTodoList = ()=>{
    todoListEl.innerHTML = tasks.map((task)=>`
          <div class="flex items-center">
              <div class="mr-4">
                  ${task.completed ? (0, _icons.checkIcon) : `<div class="w-8 h-8 border-2 border-transparent hover:border-gray-500 cursor-pointer"></div>`}
              </div>
              ...
              <div class="flex gap-2 ml-auto">
                  ${task.isEditing ? (0, _icons.getConfirmIcon)(task.id) : (0, _icons.getEditIcon)(task.id)}
                  ${(0, _icons.getDeleteIcon)(task.id)}
              </div>
          </div>
      `).join("");
...
},{}]},["lKzq4","bNKaB"], "bNKaB", "parcelRequire497d")
